                        ...
                        "schema": {
                            "properties": {
                                "attachment_ids": {
                                    ...
                                    "type": "array",
                                    "maxItems": 10,
                                    "description": "Owner-scoped opaque ready attachment IDs; skills_scan requires exactly one ZIP and validates the archive before binding."
                                },
                                "content": {
                                    "type": "string",
                                    "maxLength": 32768,
                                    "description": "skills_scan content must be empty or omitted; Skill source is supplied only by the ZIP attachment."
                                },
                                "country_iso_code": {
                                    "type": "string",
                                    "enum": [
                                ...
                                "params": {
                                    "type": "object",
                                    "description": "Exact per-task schema described by this operation. skills_scan accepts only the required model_id string; unknown parameters and credential-bearing fields are rejected."
                                },
                                "task_type": {
                                    "type": "string",
                                    "enum": [
                                ...
                                "remark": {
                                    "description": "Optional task remark, trimmed and limited to 2,000 Unicode code points. Included in idempotency and authorized detail only; never forwarded to the engine, audit metadata, or reports.",
                                    "maxLength": 2000,
                                    "type": "string"
                                }
                            },
