                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "schema": {
                            "properties": {
                                "attachment_ids": {
                                    "description": "Opaque owner-scoped attachment references for supported task types. Attachments are unsupported for new agent_scan tasks; the field must be omitted or an empty array.",
                                    "items": {
                                        "maxLength": 128,
                                        "type": "string"
                                    },
                                ...
                                "content": {
                                    "description": "Task execution input, limited to 32 KiB (32768 bytes); the character maxLength does not replace this byte limit. New agent_scan tasks require non-whitespace valid UTF-8 execution instructions that are passed to all three scan stages.",
                                    "maxLength": 32768,
                                    "type": "string"
                                },
                                "country_iso_code": {
                                ...
                                "params": {
                                    "description": "Exact per-task schema described by this operation; agent_scan accepts only agent_id and eval_model_id, both required governed string references. Arbitrary and credential-bearing fields are rejected.",
                                    "type": "object"
                                },
                                "remark": {
    ...
    "definitions": {
        ...
        "tasks.TaskDetail": {
            ...
            "properties": {
                ...
                "remark": {
                    "description": "Optional task note, trimmed and limited to 2000 Unicode code points of valid UTF-8; blank or invalid historical values are omitted. Never passed to the scan engine, audit metadata, or report snapshot.",
                    "maxLength": 2000,
                    "type": "string"
                },
                "report_id": {
