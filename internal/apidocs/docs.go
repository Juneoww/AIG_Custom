                                ...
                                "params": {
                                    ...
                                    "properties": {
                                        "authorization_confirmed": {
                                            "description": "Allowed and required only for mcp_scan service, where it must be true. repository rejects this field. The server audits only the Boolean confirmation and never exposes endpoint or authorization material.",
                                            "type": "boolean"
                                        },
                                        "source_kind": {
