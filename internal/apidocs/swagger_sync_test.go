...
func TestSwaggerDocumentsEnterpriseConsoleContracts(t *testing.T) {
	...
	for name, document := range documents {
		t.Run(name, func(t *testing.T) {
			...
			assertExactProperties(t, document, "tasks.TaskDetail", "id", "owner", "task_type", "status", "remark", "created_at", "updated_at", "input_summary")
			assertExactProperties(t, document, "tasks.TaskInputSummary", "language", "model_id", "num_prompts", "port_scan_mode", "scan_mode", "target_count", "thread", "timeout")
