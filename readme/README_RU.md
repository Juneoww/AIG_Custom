...
- [🏗️ Эволюция Архитектуры](../docs/architecture/evolution.md)
...
Подробные инструкции по использованию API, описания параметров и примеры кода см. в [полной документации API](../docs/api/reference.en.md).
<br />
<br>
