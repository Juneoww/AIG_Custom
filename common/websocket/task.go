...
type TaskCreateRequest struct {
	...
	// RuntimeParams is deliberately in-memory only. It is merged into the
	// Agent assignment frame immediately before delivery and is never a session
	// column, browser payload, or SSE event value.
	RuntimeParams  map[string]interface{} `json:"-"`
	runtimeIssuer  platformtasks.RuntimeParamsIssuer
